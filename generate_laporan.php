  ...
  <div class="container-fluid">
    <div class="row-fluid">
      ...
      <ul class="quick-actions">
        <li class="bg_lg"> <a href="cetak_transaksi.php"><i class="icon-book"></i> <h4>Uang Masuk</h4><h4>Rp. <?php echo $uang;?> ,-</h4> </a> </li>
      </ul>
    </div>
  </div>
</div>
...
<div class="row-fluid">
  <div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Restaurant <a href="#">by RestoKU</a> </div>
</div>
